...
mod tests {
    ...
    use super::{
        ...
        ReferenceMetadataMap, apply_completion_disposition, binding_is_current, build_groups,
        deep_resolve, document_state_for, read_only_toast_message, release_stale_apply_loading,
        schema_diff_is_busy,
    };
