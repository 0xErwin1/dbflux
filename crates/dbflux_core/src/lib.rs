...
pub use connection::{
    ...
    HookPhaseOutcome, HookResult, HookRunner, Identifiable, InfluxVersion, ItemManager,
    LuaCapabilities, MetricQuerySeries, MutationPolicy, OutputEvent, OutputReceiver, OutputSender,
