...
pub use connection::{
    ...
    SwitchDatabaseParams, SwitchDatabaseResult, TestConnectionResult, TreeLoadResult, TreeStore,
    WritePrivilege, compose_mutation_policy, detached_process_channel, execute_streaming_process,
