...
pub use schema::{
    ...
    SearchMappingInfo, SearchSchema, SnapshotDepth, TableAlterNormalizationError, TableChange,
    TableInfo, TableKey, TableStorageHint, TimeSeriesFieldInfo, TimeSeriesSchema,
