...
//! Docker-backed end-to-end Export test (T18): a real PostgreSQL table is
//! created and populated, then `run_export` streams it into a folder bundle
//! and the resulting CSV + manifest.json are verified against the source.
//!
